...
public class GoogleDriveService {
    ...
    public DriveFileData uploadFile(MultipartFile file, String type) throws IOException {
        ...
        // For now, skip folder validation and upload to root drive
        logger.info("Uploading to root drive (folder validation skipped)");
        
        // Skip parent folder check for now - upload to root drive instead
        logger.info("Skipping parent folder check, uploading to root drive to avoid access issues");
