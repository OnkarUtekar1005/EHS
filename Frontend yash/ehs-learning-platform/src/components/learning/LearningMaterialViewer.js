      ...
      {activeMaterial && (
        <Card variant="outlined">
          <CardContent>
            ...
            {activeMaterial.filePath && activeMaterial.fileType === 'PDF' && (
              <Box mt={2}>
                <Alert severity="info">
                  The PDF file will open in a new tab. Please mark as completed once you've finished reviewing it.
                </Alert>
              </Box>
            )}
            
            {activeMaterial.fileType === 'VIDEO' && activeMaterial.externalUrl && (
