// src/components/module/LearningMaterialsViewer.js
...
const LearningMaterialsViewer = ({ componentId, isCompleted, onComplete }) => {
        ...
        <DialogContent dividers>
          {currentMaterial && (
            <Box>
              ...
              {currentMaterial.fileType === 'PDF' && currentMaterial.filePath && (
              ...
              {currentMaterial.fileType === 'IMAGE' && currentMaterial.filePath && (
              ...
              {currentMaterial.fileType === 'HTML' && currentMaterial.content && (
                <Box dangerouslySetInnerHTML={{ __html: currentMaterial.content }} />
              )}
              
              {currentMaterial.fileType === 'EXTERNAL' && currentMaterial.externalUrl && (
                <Box>
                  <Typography paragraph>
                    External Resource: <a href={currentMaterial.externalUrl} target="_blank" rel="noopener noreferrer">
                      {currentMaterial.externalUrl}
                    </a>
                  </Typography>
                  <Button
                    variant="contained"
                    color="primary"
                    onClick={() => window.open(currentMaterial.externalUrl, '_blank')}
                  >
                    Open Resource
                  </Button>
                </Box>
              ...
              {['DOCUMENT', 'PRESENTATION'].includes(currentMaterial.fileType) && currentMaterial.filePath && (
                <Box sx={{ textAlign: 'center' }}>
                  <Typography paragraph>
                    This document type may not be viewable directly in the browser.
                  </Typography>
                  <Button
                    variant="contained"
                    color="primary"
